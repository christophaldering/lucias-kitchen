        ...
        <div className="max-w-6xl mx-auto">
          ...
          {(
            <div className="space-y-2 sm:space-y-2.5">
              ...
              {/* Feld 4: Kochidee */}
              <div className="space-y-0.5">
                <label className="text-[11px] font-medium text-[#C1693A] flex items-center gap-1 pl-0.5">
                  <Lightbulb className="w-3 h-3" /> Kochidee — im Dialog eingrenzen
                </label>
                <button
                  onClick={() => setKochideeOpen(true)}
                  className="w-full flex items-center gap-2.5 pl-4 pr-4 rounded-xl bg-[#C1693A] text-white text-sm font-medium hover:bg-[#a0542e] active:bg-[#8e4928] transition-colors min-h-[44px] text-left"
                >
                  <Lightbulb className="w-4 h-4 flex-shrink-0 opacity-90" />
                  <span className="opacity-90">Gespräch starten — beschreib einfach, worauf du Lust hast</span>
                </button>
              </div>
